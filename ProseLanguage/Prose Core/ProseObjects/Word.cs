...
namespace ProseLanguage
{
	...
	public class Word : ProseObject
	{
		...
		public Word[] isa = new Word[0];		//	We assign this at creation time.
		...
		public void addParent(Word newParent)
		{
			Word[] newIsa = new Word[isa.Length + 1];
