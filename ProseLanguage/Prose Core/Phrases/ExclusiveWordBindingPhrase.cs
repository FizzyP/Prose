...
{
	public class ExclusiveWordBindingPhrase : SimplePhrase
	{
		//
		...
		public ExclusiveWordBindingPhrase(ProseObject phraseClass, ProseObject[] pattern)
		...
		public override PNode evaluate(PNode evaluateMe, PatternMatcher successfulMatch)
		{
			...
			ExclusiveWordBindingAction action = new ExclusiveWordBindingAction(childObjectRawWords, (Word) parentObject);
